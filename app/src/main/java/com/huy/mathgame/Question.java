...
public class Question {
    ...
    // Four possible choices for the users
    private int[] answerArray;

    // Which of the 4 boxes is the answer 0 1 2 3
    private int answerPosition;

    // the maximum value of the firstNumber or 2nd number
    ...
    public Question(int upperLimit){
        ...
        int sign = randomNum.nextInt((3-0) + 1);
